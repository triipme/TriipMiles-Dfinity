...
/***/ "./src/declarations/calc/calc.did.js":
/*!*******************************************!*\
  !*** ./src/declarations/calc/calc.did.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const idlFactory = ({ IDL }) => {
  return IDL.Service({
    ...
    'clearall' : IDL.Func([], [], []),
    'div' : IDL.Func([IDL.Int, IDL.Int], [IDL.Opt(IDL.Int)], []),
...
/***/ "./src/declarations/calc/index.js":
/*!****************************************!*\
  !*** ./src/declarations/calc/index.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "idlFactory": () => (/* reexport safe */ _calc_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
...
/* harmony import */ var _calc_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./calc.did.js */ "./src/declarations/calc/calc.did.js");
 ...
 */
 const createActor = (canisterId, options) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_calc_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
 ...
 */
 const calc = createActor(canisterId);
...
"use strict";
/*!**************************************!*\
  !*** ./src/calc_assets/src/index.js ***!
  \**************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_calc__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/calc */ "./src/declarations/calc/index.js");


document.getElementById("clickMeBtn").addEventListener("click", async () => {
  const name = document.getElementById("name").value.toString();
  // Interact with calc actor, calling the greet method
  const greeting = await _declarations_calc__WEBPACK_IMPORTED_MODULE_0__.calc.greet(name);
