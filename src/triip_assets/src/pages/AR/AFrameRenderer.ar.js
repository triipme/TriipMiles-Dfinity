 ...
 */
export const AFrameContext = React.createContext();
export default class AFrameRenderer extends Component {
  ...
  render() {
    ...
    return (
      <AFrameContext.Provider value={{ inherent: this.props.inherent }}>
        {this.flush(this.props)}
...
// AFrameRenderer.childContextTypes = {
//   inherent: PropTypes.bool
// };
